...
<meta http-equiv="refresh"
	content="<%=session.getMaxInactiveInterval()%>; URL=/titulaTEC/timeout.html" />
<meta name="viewport" content="width=device-width,initial-scale=1">
<link rel="stylesheet" href="/titulaTEC/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css"
	href="/titulaTEC/css/jquery-ui-1.7.2.custom.css" />
<!-- Optional theme -->
